...
! solution of 3-d Dirichlet problem
        ...
        do iz=1,nz
        !$omp parallel do private(ix,d2x,d2y,d2z) 
        do iy=2,ny
        do ix=2,nx
        if(iz==1) then
...
!********  End of base lay determination ***************
	...
	do i=1,nx+1
        ...
        print *, elapsed_time
        call cpu_time(ar)
	       print*,'Creation bznew end: CPU TIME+ ',ar
       xx=bznew
         call fstr2
         qq=qqnew
         call cpu_time(ar)
	       print*,'Solution end: CPU TIME+ ',ar
!**************  Filtration  *************************
           qqbz(0,0)=qq(0,0)
         qq(0,0)=0.d0
...
!           correc=1.*(arg)**0.333*(1.-.7*yk(k2)/ak) !  Var 6           
         ...
         bztes=xxnew
         call cpu_time(ar)
	       print*,'Filtration end: CPU TIME+ ',ar
!************** End of filtration  *************************
...
!******************************************************************
        ...
        bzold=0.d0
        call cpu_time(ar)
	       print*,'Transformation: CPU TIME+ ',ar
!********************   Ribbon period expansion  ***********        
        ...
        call cpu_time(ar)
	       print*,'End of  Ribbon period expansion: CPU TIME+ ',ar
